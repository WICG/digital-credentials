...
- Keep the presentment of MDocs/VCs independent from the presentment of OpenID/SAML assertions. This is a plausible alternative, but early intuition is that there are more use cases where these coincide then not, and it will be useful for the verifier-holder-issuer schemes to piggy back and be able to fallback on the deployment of the rp-idp schemes.
